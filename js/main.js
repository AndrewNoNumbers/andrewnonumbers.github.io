...
(function(html) {
    ...
    * -------------------------------------------------- */
    ...
    .add({
        ...
        duration: 1000,
        begin: function(anim) {
            //window.scrollTo(0, 0); //commented out by Andrew to allow links to scroll directly to anchor
        }
    })
    .add({
        targets: '#preloader',
    ...
    * ----------------------------------------------------- */
    const ssPhotoswipe = function() {
        ...
        // bind click event (disabled by Andrew to disable intercepting of click to open lightbox)
